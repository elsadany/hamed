        ...
        <div class="address">
            ...
            <p >Select payment method</p>
                ...
                <label for="pay-method-01" class="d-block text-capitalize mb-3 pay-method">
                     <input type="radio" id="pay-method-01"  v-model="pay_method" value="1" class="mr-3" checked>
                     <img src="web/images/icons/cash.png" alt="">
                     cash
                </label>
                <label for="pay-method-02" class="d-block text-capitalize">
                     <input type="radio" id="pay-method-02"  v-model="pay_method" value="2" class="mr-3">
...
export default {
  ...
  'danger'
        ...
        checkout(e){
            ...
            let data={lang_id:this.$store.state.lang.active_lang,address_id:this.address.id,pay_method:this.pay_method};
            ...
            axios.post('/api/checkout',
                ...
                console.log(res.data);
                    ...
                    window.location='/payment/'+res.data.data.id;
