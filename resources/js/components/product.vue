                        ...
                        <h4 class="y-color">
                            {{product.options.option}}
                              ...
                              <label class="color-label " style="margin: 5px;" v-for="(color,z) in product.options.values" :key="'icolor'+z" :for="'color'+z" >
                                  <input type="radio" :id="'color'+z"  v-model="value_id"  :style="'background:'+color.code" :value="color.value_id"  name="value_id">
                        </label>
...
export default {
    ...
    methods:{
       ...
       if(this.product.has_options==true&&this.value_id==null){
alert('please choose the product option');
return false;
       }
