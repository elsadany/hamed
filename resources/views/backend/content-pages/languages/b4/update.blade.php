...
@section("title"){{trans("pages::page.update")}} {{trans("pages::page.page")}} {{trans("pages::page.language")}} @stop
...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">{{trans("pages::page.update")}}</li>
</ol>


<div class="card">
    <div class="card-header bg-primary"><h3 class="card-title text-light">{{trans("pages::page.update")}} {{trans("pages::page.pages")}}</h3></div>
    <div class="card-body">
