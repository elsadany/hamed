...
@section("title"){{trans("pages::page.update")}} {{trans("pages::page.page")}} @stop
...
<ol class="breadcrumb">
  ...
  <li class="active breadcrumb-item">{{trans("pages::page.update")}}</li>
</ol>


<div class="card">
    <div class="card-header bg-primary"><h3 class="card-title  text-light">{{trans("pages::page.update")}} {{trans("pages::page.page")}}</h3></div>
    <div class="card-body">
