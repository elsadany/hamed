...
<head>
    ...
    <!-- END Custom CSS--> --}}
    <link rel="stylesheet" type="text/css" href="./assets/backend/css/select2.min.css">
...
<body class="vertical-layout vertical-menu 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu" data-col="2-columns">
    ...
    <script src="./assets/backend/js/scripts/customizer.min.js" type="text/javascript"></script>
         ...
         <script src="./assets/backend/vendors/js/tables/datatable/datatables.min.js"></script>
        <script src="./assets/backend/js/scripts/tables/datatables/datatable-basic.min.js"></script>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-sweetalert/1.0.1/sweetalert.min.js"></script>
        <script type="text/javascript" src="./assets/backend/js/select2.full.min.js"></script>
           
        <script type="text/javascript" src="./assets/backend/js/jquery.growl.js"></script>
